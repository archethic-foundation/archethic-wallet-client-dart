...
OpenSessionResponse _$OpenSessionResponseFromJson(Map<String, dynamic> json) {
  return _OpenSessionResponse.fromJson(json);
}

/// @nodoc
mixin _$OpenSessionResponse {
  String get sessionId => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $OpenSessionResponseCopyWith<OpenSessionResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $OpenSessionResponseCopyWith<$Res> {
  factory $OpenSessionResponseCopyWith(
          OpenSessionResponse value, $Res Function(OpenSessionResponse) then) =
      _$OpenSessionResponseCopyWithImpl<$Res, OpenSessionResponse>;
  @useResult
  $Res call({String sessionId});
}

/// @nodoc
class _$OpenSessionResponseCopyWithImpl<$Res, $Val extends OpenSessionResponse>
    implements $OpenSessionResponseCopyWith<$Res> {
  _$OpenSessionResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$OpenSessionResponseImplCopyWith<$Res>
    implements $OpenSessionResponseCopyWith<$Res> {
  factory _$$OpenSessionResponseImplCopyWith(_$OpenSessionResponseImpl value,
          $Res Function(_$OpenSessionResponseImpl) then) =
      __$$OpenSessionResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String sessionId});
}
...
/// @nodoc
class __$$OpenSessionResponseImplCopyWithImpl<$Res>
    extends _$OpenSessionResponseCopyWithImpl<$Res, _$OpenSessionResponseImpl>
    implements _$$OpenSessionResponseImplCopyWith<$Res> {
  __$$OpenSessionResponseImplCopyWithImpl(_$OpenSessionResponseImpl _value,
      $Res Function(_$OpenSessionResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$OpenSessionResponseImpl(
      sessionId: null == sessionId
          ? _value.sessionId
          : sessionId // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$OpenSessionResponseImpl extends _OpenSessionResponse {
  const _$OpenSessionResponseImpl({required this.sessionId}) : super._();

  factory _$OpenSessionResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$OpenSessionResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'OpenSessionResponse(sessionId: $sessionId)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$OpenSessionResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$OpenSessionResponseImplCopyWith<_$OpenSessionResponseImpl> get copyWith =>
      __$$OpenSessionResponseImplCopyWithImpl<_$OpenSessionResponseImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$OpenSessionResponseImplToJson(
      this,
    );
  }
}

abstract class _OpenSessionResponse extends OpenSessionResponse {
  const factory _OpenSessionResponse({required final String sessionId}) =
      _$OpenSessionResponseImpl;
  const _OpenSessionResponse._() : super._();

  factory _OpenSessionResponse.fromJson(Map<String, dynamic> json) =
      _$OpenSessionResponseImpl.fromJson;
